...
export const ContextCommand = {
     ...
     * @type {String}
     */
    description: "Give the User a boop!",
    ...
    async executeCommand(interaction, interactionUser) {
        ...
        if ( interaction.data.target_id === SenderId ) {
            displayMessage = localize(interaction.locale, 'ACTION_COMMAND_SELF_USER_BOOP', SenderDisplayName);
        }
        // Used on this App
        else if ( interaction.data.target_id === DISCORD_APP_USER_ID ) {
            displayMessage = localize(interaction.locale, 'ACTION_COMMAND_TWILITE_BOOP', SenderDisplayName);
        }
        ...
        // Used on any non-App User
            ...
            displayMessage = localize(interaction.locale, 'ACTION_COMMAND_OTHER_USER_BOOP', SenderDisplayName, TargetDisplayName);
        }
