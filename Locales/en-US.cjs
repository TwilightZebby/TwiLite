module.exports = {
    ...
    ACTION_COMMAND_OTHER_USER_NIBBLE_AFFECTIONATE: `**{{0}}** gave **{{1}}** an affectionate bite`,
    ACTION_COMMAND_OTHER_USER_NIBBLE_HUNGRY: `**{{0}}** was hungry and took a bite out of **{{1}}**!`,
    ACTION_COMMAND_OTHER_USER_NIBBLE_FERAL: `**{{0}}** went feral and bit **{{1}}**!`,
    ACTION_COMMAND_OTHER_USER_NIBBLE_KINKY: `**{{0}}** slowly bit **{{1}}**'s shoulder kinkly...`,
    ...
    ACTION_COMMAND_SELF_USER_NIBBLE_AFFECTIONATE: `**{{0}}** took a bite out of themselves`,
    ACTION_COMMAND_SELF_USER_NIBBLE_HUNGRY: `**{{0}}** was hungry and mistook themselves as food`,
    ACTION_COMMAND_SELF_USER_NIBBLE_FERAL: `**{{0}}** went feral and bit themselves in their confusion`,
    ACTION_COMMAND_SELF_USER_NIBBLE_KINKY: `**{{0}}** took a bite out of themselves`,
    ...
    ACTION_COMMAND_ROLE_NIBBLE_AFFECTIONATE: `**{{0}}** took a collective bite out of **{{1}}**`,
    ACTION_COMMAND_ROLE_NIBBLE_HUNGRY: `**{{0}}** was *very* hungry and took a bite out of **{{1}}**`,
    ACTION_COMMAND_ROLE_NIBBLE_FERAL: `**{{0}}** went feral like a wild animal and bit **{{1}}**`,
    ACTION_COMMAND_ROLE_NIBBLE_KINKY: `**{{0}}** took a collective bite out of **{{1}}**`,
    ...
    ACTION_COMMAND_EVERYONE_NIBBLE_AFFECTIONATE: `**{{0}}** took a collective bite out of \`@everyone\``,
    ACTION_COMMAND_EVERYONE_NIBBLE_HUNGRY: `**{{0}}** was hungry and started to see \`@everyone\` as walking food...`,
    ACTION_COMMAND_EVERYONE_NIBBLE_FERAL: `**{{0}}** took a collective bite out of \`@everyone\``,
    ACTION_COMMAND_EVERYONE_NIBBLE_KINKY: `**{{0}}** took a collective bite out of \`@everyone\``,
    ...
    ACTION_COMMAND_OTHER_APPS_NIBBLE_AFFECTIONATE: `**{{0}}** took a bite out of **{{1}}**'s internal wires`,
    ACTION_COMMAND_OTHER_APPS_NIBBLE_HUNGRY: `**{{0}}** took a bite out of **{{1}}**'s internal wires, mistaking it for spaghetti`,
    ACTION_COMMAND_OTHER_APPS_NIBBLE_FERAL: `**{{0}}** took a bite out of **{{1}}**'s internal wires`,
    ACTION_COMMAND_OTHER_APPS_NIBBLE_KINKY: `**{{0}}** took a bite out of **{{1}}**'s internal wires`,
    ...
    ACTION_COMMAND_TWILITE_NIBBLE_AFFECTIONATE: `**{{0}}** took a bite out of my code?!`,
    ACTION_COMMAND_TWILITE_NIBBLE_HUNGRY: `**{{0}}** was hungry and mistook my computer chips as potato chips D:`,
    ACTION_COMMAND_TWILITE_NIBBLE_FERAL: `**{{0}}** went feral and took a bite out of my code??`,
    ACTION_COMMAND_TWILITE_NIBBLE_KINKY: `Listen **{{0}}**, I'm not allowing you to bite me in a kinky way.`,
    ...
    ACTION_COMMAND_MEE6_NIBBLE_AFFECTIONATE: `**{{0}}** tried to bite **{{1}}**'s rotten code, but spat it back out again!`,
    ACTION_COMMAND_MEE6_NIBBLE_HUNGRY: `**{{0}}** tried to bite **{{1}}**'s rotten code, but spat it back out again!`,
    ACTION_COMMAND_MEE6_NIBBLE_FERAL: `**{{0}}** tried to bite **{{1}}**'s rotten code, but spat it back out again!`,
    ACTION_COMMAND_MEE6_NIBBLE_KINKY: `**{{0}}** tried to bite **{{1}}**'s rotten code, but spat it back out again!`,
...
**An auto-updating preview of what your updated Role Menu will look like is shown below.**`,
    ...
    DELETE_ROLE_MENU_CONFIRMATION_BUTTON_LABEL: `Delete Menu`,
    DELETE_ROLE_MENU_CANCEL_BUTTON_LABEL: `Cancel deletion`,
    ...
    DELETE_ROLE_MENU_COMMAND_ERROR_GENERIC: `Sorry, there was an error trying to delete that Role Menu.\nIf you have **Manage Messages** Permission in this Channel, you can delete that Role Menu yourself using Discord's "Delete Message" option.`,
    ...
    ROLE_MENU_ADD_ROLE_MODAL_BUTTON_COLOR_LABEL: `Button's color`,
    ROLE_MENU_ADD_ROLE_MODAL_BUTTON_COLOR_DESCRIPTION: `What color should this Role's Button display as on your Menu?`,
    ROLE_MENU_ADD_ROLE_MODAL_BUTTON_COLOR_SELECT_PLACEHOLDER: `Pick a color`,
...
- **Single-use** - Users can only use a **Single-use** Menu once, and are unable to revoke or swap out the selected Role from themselves. Useful for Team Roles in Events.`,
    ...
    ROLE_MENU_SET_MENU_DETAILS_MODAL_MENU_COLOR_LABEL: `Menu's Color`,
    ROLE_MENU_SET_MENU_DETAILS_MODAL_MENU_COLOR_DESCRIPTION: `Set the optional sidebar color for your Role Menu. MUST be in a hex code format (eg: #ab44ff)`,
